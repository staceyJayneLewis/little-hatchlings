...
- When checking the hero image and image border down the 320px responsiveness on the developer tools both elements stay within it's container and is fully responsive with each breakpoint and column change. 
border hidden and shown when should on each breakpoint
- hero heading button and responsiveness of the heading
- carousel - automatically slides through the testimonials and slide show buttons
- video - no autoplay and plays through until end
- about section incl button
- achievements
- our values section with image incl button
- gallery heading
