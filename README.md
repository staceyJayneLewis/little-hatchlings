...
<!-- overview of project -->
Little Hatchlings is a chilcare nursery that are looking to stand out against other competitiors and to develop more centers around Wales and so the business owners are looking to invest in a website that will give the best representation of the nursery and what they can expect. The nursery's aim is to encourage parents to book a viewing of the nursery to increase the nursery applications and grow the business. 
Many nurseries like Little Hatchlings do not have a website at all or depend on social media pages such as facebook and twitter to hold any contact information and updates of the nursery. 
After I conducted my own research online and creating my own survey on surveyMonkey (https://www.surveymonkey.co.uk/r/WXV275K) it is apparent that since we are becoming a more digital dominated world that most parents use online/mobile as their first method of searching for a nursery. Using my online research but also speaking to the nursery owner directly it is also clear that the nurserys target audience is around 18 - 40 and this age range the audience are likely to be tech savvy and so a website is the perfect way to give that first impression to the target audience. The website is responsive ans so can be accessed on most devices such as mobile, tablet and laptop/computer making it user friendly for most cusomters.
...
| Size | Screenshot |
| --- | --- |
| From left to right: Mobile Tablet Desktop | ![screenshot](documentation/wireframes/homepage-wireframe.png) |
	
### Gallery Page Wireframes
	
| Size | Screenshot |
| --- | --- |
| From left to right: Mobile Tablet Desktop | ![screenshot](documentation/wireframes/gallery-wireframe.png) |
	
### Contact Page Wireframes

| Size | Screenshot |
| --- | --- |
| From left to right: Mobile Tablet Desktop | ![screenshot](documentation/wireframes/contact-wireframe.png) |	
